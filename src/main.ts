...
function main() {
  ...
  gui.addColor(controls, 'meshColor')
  ...
  function tick() {
    ...
    // TO SEE ONLY THE CUBE UN COMMENT THIS AND COMMENT THE REST OF THE RENDER CALLS
    // renderer.render(camera, time, controls.meshColor, gradient, [
    // //   icosphere,
    // //    square,
    //   cube,
    // ], false);
    renderer.render(camera, time, controls.meshColor, lambert, [
      icosphere,
      // square,
      //cube,
    ], false);
    renderer.render(camera, time, controls.meshColor, passthrough, [
      icosphere,
      // square,
      //cube,
    ], false);
